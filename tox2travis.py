...
matrix:
  allow_failures:
    ...
    - env: TOX_ENV=pypy-twisted_15.3.0-pyopenssl_0.14
    - env: TOX_ENV=pypy-twisted_15.3.0-pyopenssl_0.15.1
    - env: TOX_ENV=pypy-twisted_current-pyopenssl_0.14
    - env: TOX_ENV=pypy-twisted_current-pyopenssl_0.15.1
